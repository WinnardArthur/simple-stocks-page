...
export default function Header() {
  return (
    <div className="flex justify-between items-center gap-x-4 md:gap-x-6 lg:gap-x-12 px-4 sm:px-6 py-4">
      <div>
        <Image
          src="/images/logewithname.png"
          width={80}
          height={80}
          alt="logo"
        />
      ...
      <div className="flex-1 relative lg:mr-[4rem]">
        <div className="border border-gray-400 rounded-md shadow flex items-center justify-between  p-2 sm:p-3 bg-zinc-200">
          <input
            type="text"
            className="w-[98%] text-[.9rem] sm:text-[1rem] outline-none border-none bg-transparent"
          />
          <FiSearch className="text-[1.1rem] sm:text-[1.4rem] text-gray-600" />
        </div>
      </div>

      <div className="">
        <div className="md:hidden">
          <div className="flex w-[2.5rem] h-[2.5rem] relative">
            <Image
              fill
        ...
        <div className="hidden md:flex items-center gap-x-4">
          <a href="#" className="text-gray-500 font-medium text-[.9rem]">
            Contact US
          </a>
          <a
            href="#"
            className="border shadow border-gray-400 rounded px-5 py-[.6rem] text-[.9rem] font-medium text-gray-500"
          >
            SIGN UP
          </a>
          <a
