  ...
  return (
    <div>
        ...
        <div className='bg-slate-200'>
          <motion.div variants={featuredCompaniesVariants} initial="initial" animate="animate" className='flex justify-between gap-x-4 px-4 py-2 md:py-6 overflow-x-scroll featured_companies no-scrollbar'>
            {imagesData?.map((item) => {
              return(
