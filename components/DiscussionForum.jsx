...
export default function DiscussionForum({ screenSize }) {
  return (
    <div>
        <h2 className='hidden md:block text-red-400 font-medium text-xl px-4 py-3'>DISCUSSION FORUM</h2>

        <div className='px-2 lg:px-4 pl-[2.2rem] lg:pl-[4rem]'>
            <h5 className='font-medium text-[1rem] lg:text-lg mt-4 lg:mt-0 mb-1 lg:mb-2'>Filters</h5>
            <div className='bg-white flex justify-between items-center py-4 px-2 rounded-md shadow-md drop-shadow-xl mb-4'>
                <button className='rounded-[5rem] w-fit px-2 lg:w-[6rem] bg-red-700 text-white  text-[.75rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 1</button>
                <button className='rounded-[5rem] w-fit px-2 lg:w-[6rem] bg-blue-800 text-white  text-[.75rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 2</button>
                <button className='rounded-[5rem] w-fit px-2 lg:w-[6rem] bg-yellow-500 text-white  text-[.75rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 3</button>
                
                <div className='w-[35%] rounded-[5rem] flex items-center bg-white lg:bg-zinc-200 border border-gray-400 shadow px-1 py-[.32rem] pl-2 text-gray-600'>
                    <FiSearch className='text-[.95rem] lg:text-[1rem]'/>
                    <input type='text' placeholder="Search here" className='w-[90%] lg:ml-1 text-[.95rem] lg:text-[.9rem] outline-none bg-transparent text-black'/>
                </div>
            </div>

            <div>
                <div className='relative bg-white shadow-lg drop-shadow-xl rounded-md pt-[3rem] pb-[1rem]'>
                    <p className='absolute text-blue-400 right-4 top-4 text-[.84rem] sm:text-sm cursor-pointer font-medium'>2 min ago</p>
                    ...
                    <div className='flex justify-between gap-x-4 px-2 lg:px-8 mt-2 lg:mt-6'>
                        ...
                        <div className='flex-1 pt-2'>
                            <div className='flex items-center'>
                                ...
                                <button className='rounded-[5rem] px-3 lg:px-4 bg-red-700 text-white text-[.8rem] lg:text-[.85rem] py-[0.2rem] font-medium'>Sector 1</button>
                            </div>
                            <p className='text-gray-600 font-medium text-[.85rem] lg:text-[.9rem] mt-3 lg:mt-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is</p>

                            <div className='flex justify-between mt-4 lg:mt-8'>
                                <button className='flex items-center gap-x-1'>
                                    <AiFillHeart className='text-red-600 lg:text-2xl'/>
                                    <h6 className='text-[.8rem] lg:text-[.9rem] font-medium text-gray-600'>2K</h6>
                                </button>
                                <button className='flex items-center gap-x-1'>
                                ...
                                <button className='flex items-center gap-x-1'>
                                    ...
                                    <h6 className='text-[.8rem] lg:text-[.9rem] font-medium text-gray-600'>2K Comments</h6>
                                </button>
                                <button className='flex items-center gap-x-1'>
                ...
                <div className='mt-4 relative bg-white shadow-lg rounded-md py-[.5rem]'>
                    <p className='absolute text-blue-400 right-4 top-4 text-sm cursor-pointer font-medium'>2 min ago</p>
                    <div className='flex justify-between gap-x-4 px-8'>
                        <div className='flex w-[3rem] h-[3rem] relative'>
                            <Image 
                                fill 
                                className='rounded-full object-cover' 
                                src='https://static.vecteezy.com/system/resources/thumbnails/002/002/257/small_2x/beautiful-woman-avatar-character-icon-free-vector.jpg' alt="user"
                            />   
                        </div>
                        
                        <div className='flex-1 pt-2'>
                            <div className='flex items-center'>
                                <h5 className='text-[.9rem] font-medium text-gray-600 mr-8'>Lorem Ipsum</h5>
                                <button className='rounded-[5rem] w-[6rem] bg-blue-800 text-white text-[.85rem] py-[0.2rem] font-medium'>Sector 1</button>
                            </div>
                            <p className='text-gray-600 font-medium text-[.9rem] mt-3'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is</p>

                            <div className='flex justify-between mt-3'>
                                <button className='flex items-center gap-x-1'>
                                    <AiOutlineHeart className='text-gray-600 text-2xl'/>
                                    <h6 className='text-[.9rem] font-medium text-gray-600'>2K</h6>
                                </button>
                                <button className='flex items-center gap-x-1'>
                                    <MdOutlineVisibility className='text-gray-600 text-2xl'/>
                                    <h6 className='text-[.9rem] font-medium text-gray-600'>2K</h6>
                                </button>
                                <button className='flex items-center gap-x-1'>
                                    <BiComment className='text-gray-600 text-2xl'/>
                                    <h6 className='text-[.9rem] font-medium text-gray-600'>2K Comments</h6>
                                </button>
                                <button className='flex items-center gap-x-1'>
                                    <FiShare2 className='text-gray-600 text-2xl'/>
                                    <h6 className='text-[.9rem] font-medium text-gray-600'>Share</h6>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex justify-between gap-x-4 px-8'>
                        <div className='flex w-[3rem] h-[3rem] relative'>
                            <Image 
                                fill 
                                className='rounded-full object-cover' 
                                src='https://static.vecteezy.com/system/resources/thumbnails/002/002/247/small_2x/beautiful-black-woman-avatar-character-icon-free-vector.jpg' alt="user"
                            />   
                        </div>
                        ...
                        <div className='flex-1 pt-2'>
                            <div className='flex items-center'>
                                <h5 className='text-[.9rem] font-medium text-gray-600 mr-8'>Lorem Ipsum</h5>
                                <button className='rounded-[5rem] w-[6rem] bg-yellow-500 text-white text-[.85rem] py-[0.2rem] font-medium'>Sector 1</button>
                            </div>
                            <p className='text-gray-600 font-medium text-[.9rem] mt-3'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is</p>
                    ...
                    <div className='flex justify-between gap-x-4 px-8'>
                        <div className='flex w-[3rem] h-[3rem] relative'>
                            <Image 
                                fill 
                                className='rounded-full object-cover' 
                                src='https://static.vecteezy.com/system/resources/thumbnails/006/487/917/small_2x/man-avatar-icon-free-vector.jpg' alt="user"
                            />   
                        </div>
                    ...
                    <div className='flex justify-between gap-x-4 px-8'>
                        <div className='flex w-[3rem] h-[3rem] relative'>
                            <Image 
                                fill 
                                className='rounded-full object-cover' 
                                src='https://static.vecteezy.com/system/resources/thumbnails/002/002/300/small_2x/beautiful-woman-avatar-character-icon-free-vector.jpg' alt="user"
                            />   
                        </div>
