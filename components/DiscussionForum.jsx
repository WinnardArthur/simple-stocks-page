    ...
    <div>
        ...
        <div className='px-1 lg:px-4 pl-[1.6rem] md:pl-[2rem] lg:pl-[3.5rem] pb-5'>
            ...
            <div className='bg-white flex justify-between items-center py-4 px-1 sm:px-2 md:px-3 lg:px-6 rounded-md shadow shadow-gray-400 drop-shadow-xl mb-4'>
                <button className='rounded-[5rem] w-fit px-1 sm:px-6 md:px-3 bg-red-700 text-white text-[.7rem] sm:text-[.8rem] md:text-[.8rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 1</button>
                <button className='rounded-[5rem] w-fit px-1 sm:px-6 md:px-3 bg-blue-800 text-white text-[.7rem] sm:text-[.85rem] md:text-[.8rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 2</button>
                <button className='rounded-[5rem] w-fit px-1 sm:px-6 md:px-3 bg-yellow-500 text-white text-[.7rem] sm:text-[.85rem] md:text-[.8rem] lg:text-[.85rem] py-[.3rem] font-medium'>Sector 3</button>
                            ...
                            </p>
                            {
                                ...
                                <div className='flex justify-center pt-[1.5rem] sm:pt-[3rem]'>
                                    <div className='relative w-[80%] sm:w-[60%] md:w-[70%] h-[6rem] sm:h-[7rem] lg:h-[7rem]'>
                                        <Image src='/images/infobeam3.jpg' fill className='object-contain'/>
                                    </div>
                                </div>
                            }
                            ...
                            <div className='flex justify-between gap-x-1 px-1 sm:px-2 lg:px-4 mt-5 lg:mt-4'>
                                ...
                                <div className='flex-1 pt-2'>
                                    <div className='flex items-center'>
                                        <h5 className='font-medium text-gray-600 text-[.8rem] sm:text-[.9rem] mr-2 sm:mr-6'>Lorem Ipsum</h5>
                                        <button className='rounded-[5rem] px-2 sm:px-3 md:px-4 text-white text-[.75rem] sm:text-[.8rem] lg:text-[.85rem] py-[0.2rem] font-medium' style={{backgroundColor: data.color}}>Sector 1</button>
                                    </div>
                                    ...
                                    <div className='flex justify-between gap-x-2 sm:gap-x-0 mt-4 lg:mt-8'>
                                        ...
                                        <button className='flex items-center gap-x-1'>
                                            ...
                                            <h6 className='text-[.6rem] sm:text-[.8rem] md:text-[.9rem] font-medium text-gray-600'>Share</h6>
                                        </button>
                                    </div>
                                </div>
                            </div>
