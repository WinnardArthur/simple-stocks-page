    ...
    <div className="fixed bottom-0 left-0 right-0 text-gray-100 bg-primary-color block md:hidden">
      <div className="flex items-center">
        <button
          ...
          className={`${
            active === "dashboard" ? "border-b-2 border-red-500" : ""
          } py-3 w-[20%] flex justify-center`}
        >
        ...
        <button
          ...
          className={`${
            active === "grid" ? "border-b-2 border-red-500" : ""
          } py-3 w-[20%] flex justify-center`}
        >
          <BsGrid />
        </button>
        ...
        <button
          ...
          className={`${
            active === "chat" ? "border-b-2 border-red-500" : ""
          } py-3 w-[20%] flex justify-center`}
        >
        ...
        <button
          ...
          className={`${
            active === "list" ? "border-b-2 border-red-500" : ""
          } py-3 w-[20%] flex justify-center`}
        >
